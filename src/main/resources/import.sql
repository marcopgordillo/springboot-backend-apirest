...
INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('andres', '$2a$10$bPtp8sydJIRbbLgvQ/c8X.roczfWWE0A2OCVh1di3Xn5GWLgTxumq', true, 'Andrés', 'Guzman', 'profesor@bolsadeideas.com');
INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('admin', '$2a$10$4jfNkOxNhLST4817QY0avOK9eUaWG.9EvUW6Y0V0HWuTAe3FVDEkq', true, 'John', 'Doe', 'john.doe@bolsadeideas.com');
...
INSERT INTO productos (nombre, precio, create_at) VALUES ('Panasonic Pantalla LCD', 259990, DATE(NOW()));
INSERT INTO productos (nombre, precio, create_at) VALUES ('Apple IPOD Shuffle', 1499990, DATE(NOW()));
INSERT INTO productos (nombre, precio, create_at) VALUES ('Sony Notebook Z110', 37990, DATE(NOW()));
INSERT INTO productos (nombre, precio, create_at) VALUES ('Hewlett Packard Multifuncional F2280', 69990, DATE(NOW()));
INSERT INTO productos (nombre, precio, create_at) VALUES ('Bianchi Bicicleta aro 26', 69990, DATE(NOW()));
INSERT INTO productos (nombre, precio, create_at) VALUES ('Mica comoda 5 cajones', 299990, DATE(NOW()));
INSERT INTO productos (nombre, precio, create_at) VALUES ('Sony Camara Digital DSC-W320B', 123490, DATE(NOW()));
